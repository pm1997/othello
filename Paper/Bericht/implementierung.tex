...
\\Die Datenbank besteht aus 60 Zeilen und 9 Spalten. Die neun Spalten stellen o.g. Spielfelder dar. Jede Zelle in dieser Tabelle enthält ein Tripel. Die erste Komponente stellt die Anzahl der gewonnen Spiele des ersten Spielers dar, in welchem eine Zelle der Spielfeldkategorie zu in dieser Zugzahl gespielt wurde. 
