...
Die Python Implementierung befindet sich im Verzeichnis \mxZitat{python} des zu diesem Projekt gehörenden Git Repository. Um das Spiel zur Ausführung zu bringen werden die Pakete \mxZitat{numpy} sowie \mxZitat{pandas} benötigt. Sind diese Abhängigkeiten vorhanden, kann das Spiel durch das Ausführen des Kommandos \code{python3 main-game} gestartet werden. Es wird eine Pythonversion von 3.6.7 oder aktueller benötigt.
...
%\subsubsection{Nutzung der gewichteten Random Funktion}
