...
\item $\mathtt{c} \in \{\mathtt{Fields} -\ \{\langle d,4 \rangle\,\langle e,4 \rangle\,\langle d,5 \rangle\,\langle e,5 \rangle\} \}$ : $c$ ist eine Teilmenge der Spielfelder außer die Zentrumsfelder (Kategorie \mxZitat{X})
\end{itemize}
