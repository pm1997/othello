...
\\$\mathtt{stored\_mc\_heuristic}(\mathtt{s}, \mathtt{m}) = ${\large $ \frac{\mathtt{w}(\mathtt{database}(\mathtt{turn}(\mathtt{s}),\mathtt{category}(\mathtt{m})),\mathtt{player}(\mathtt{s}))}{\mathtt{t}(\mathtt{database}(\mathtt{turn}(\mathtt{s}),\mathtt{category}(\mathtt{m})),\mathtt{player}(\mathtt{s}))} $ }
