...
\\Ist dies der Fall so werden in Zeile 3 alle gemäß der Startbibliothek in Frage kommenden Züge ermittelt. Steht mindestens ein Zug zur Auswal (Z. 4) so wird dieser gespielt. Nun werden die im vorherigen Zug ermittelten Wahrscheinlichekiten gelöscht(Z. 6) und das Symbol, welches zur Repräsentation des eigenen Spielers verwendet wird zwischengespeichert (Z.6)
