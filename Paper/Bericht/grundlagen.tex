...
Allen zuvor genannten Spielstrategien ist gemein, dass sie eineHeuristik, also eine Funktion zur Bewertung eines Spielzustandes, benötigen. Auf die Gewinnaussichten haben jedoch verschiedene Faktoren Einfluss. Eine Beschreibung dieser Faktoren findet sich im nachfolgenden Kapitel. Die Frage ist nun wie die einzelnen Faktoren zu gewichten sind. Eine Möglichkeit um die optimale Gewichtung zu ermitteln besteht darin die Faktoren iterativ zu bestimmen.\\
Dabei werden zunächst alle Faktoren gleich gewichtet. Mit dieser Heuristik wird dann der Spielbaum bis zu einer zuvor festgelegten Tiefe berechnet. Jene Faktoren die die Wahl des demnach besten Zuges nahelegen werden daraufhin stärker gewichtet. Die Heuristik mit den neuen Faktoren ist dann der Ausgangspunkt für weitere Iterationen.\\
Bei einer entsprechend großen Anzahl von Iterationen konvergieren die Faktoren zu einer optimalen Gewichtung.
