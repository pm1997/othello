...
\\Auffällig ist außerdem, dass im Vergleich zu dem \mxZitat{Monte Carlo}-Agenten eine deutlich längere Rechenzeit benötigt wird um zu einem insgesamt schlechteren Ergebnis zu kommen. Auf die Performance der beiden Agenten im direkten Vergleich wird in Abschnitt \ref{subsec:Fazit:AgentenVgl} eingegangen.
\todo{MC}
\paragraph{Weitere Variationsmöglichkeiten}
