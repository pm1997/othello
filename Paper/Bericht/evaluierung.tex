...
Abschließend wird noch die Stored Monte Carlo Heuristik mit den jeweils anderen Heuristiken verglichen. Daraus ergeben sich die Vergleiche 15 bis 18.
...
% Bei einigen Kombinationen war es aus Gründen der erforderlichen Rechenzeit jedoch nicht möglich 1000 Vergleiche durchzuführen. Daher wird 
Zu jedem \ac{Vgl} wird die Anzahl der durchgeführten Spiele, sowie jeweils die Gewinnwahrscheinlichkeit angegeben. Die Ergebnisse dieser Vergleiche finden sich in Tabelle \ref{tbl:cmp-results}:
...
\rowfont{\color{grey}}
12 &  200 &    0 &   0,0 &  194 &  97,0 & 1095,48020 & 293,03959 \\ \hline
