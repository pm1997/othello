...
\\Bei der Bestimmung der Parameter hat sich gezeigt, dass die beim Agenten \mxZitat{\abp} gewählte Heuristik die Gewinnchance des Agenten wesentlich beeinflusst. Aus diesem Grund wird der \mxZitat{\abp}-Agent mit allen zur Verfügung stehenden Heuristiken seperat betrachtet. Die sich daraus Ergebenden Vergleiche (Vgl.) sind in Tabelle \ref{tbl:cmp-agents} dargestellt. Der Agent \mxZitat{\abp} wird dabei durch \mxZitat{AB} abgekürzt.
...
\rowfont{\color{grey}}
14 &   54 &   54 & 100,0 &    0 &   0,0 & 134,97487 & 419,56844 \\ \hline
\end{tabu}
\end{center}
